import 'package:black_history_gram/View/books_screen.dart';
import 'package:black_history_gram/View/favorite_screen.dart';
import 'package:black_history_gram/View/shelves_screen.dart';
import 'package:black_history_gram/View/wishlist_screen.dart';
...
class _SearchScreenState extends State<SearchScreen> with TickerProviderStateMixin {
  ...
  Color _foregroundOff = kDarkGreyColor;

  // active button's background color
  Color _backgroundOn = Color(0xFF79261F);
  Color _backgroundOff = kGreyColor;
  ...
  void initState() {
    ...
    for (int index = 0; index < _tabTitle.length; index++) {
      // create a GlobalKey for each Tab
      _keys.add(new GlobalKey());
    }

    // this creates the controller with 6 tabs (in our case)
    _controller = TabController(vsync: this, length: _tabTitle.length);
              ...
              children: [
                ...
                Padding(
                  ...
                  //  color: Colors.grey,
                    ...
                    child: Container(
                      child: Text('LIBRARY',style: TextStyle(fontSize: 15,fontWeight: FontWeight.bold),),
                    ),
                  ),
                ),
              ],
            ...
            child: Container(
                ...
                child: ListView.builder(
                  // this gives the TabBar a bounce effect when scrolling farther than it's size
                    ...
                    // number of tabs
                    itemCount: _tabTitle.length,
                    itemBuilder: (BuildContext context, int index) {
                      return Padding(
                        // each button's key
                          key: _keys[index],
                          // padding for the buttons
                          padding: EdgeInsets.only(top: 8,left: 5,right: 2),
                          child: ButtonTheme(
                              child: AnimatedBuilder(
                                ...
                                builder: (context, child) => Container(
                                  ...
                                  child: FlatButton(
                                    ...
                                    child: Text(_tabTitle[index], style: TextStyle(fontSize: 11, fontWeight: FontWeight.w400, color: _getForegroundColor(index)),),
                                    // child: Icon(
                                    //   // get the icon
                                    //   _icons[index],
  ...
  _scrollTo(int index) {
    ...
    if (offset < 0) {
      ...
      // get the last button
      renderBox = _keys[_tabTitle.length - 1].currentContext.findRenderObject();
      // get its position
      position = renderBox.localToGlobal(Offset.zero).dx;
      // and size
